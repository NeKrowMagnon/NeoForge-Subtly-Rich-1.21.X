...
public class SculkRemnantItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        if (Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("tooltip_subtlyrich_sculk_remnant.shift_down"));
        } else {
            tooltipComponents.add(Component.translatable("tooltip_subtlyrich_sculk_remnant"));
        }
